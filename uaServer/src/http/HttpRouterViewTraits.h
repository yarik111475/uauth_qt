...
struct HttpRouterViewTraits : HttpRouterViewTraits<decltype(&ViewHandler::operator())> {};

template <typename ClassType, typename Ret, typename ... Args>
struct HttpRouterViewTraits<Ret(ClassType::*)(Args...) const>
{
...
private:
    // Tools used to check position of special arguments (HttpResponder, HttpRequest)
    // and unsupported types
    template<bool Last, typename Arg>
    static constexpr bool checkArgument() noexcept
    {
            static_assert(Last || !std::is_same<Arg, const HttpRequest &>::value,
                          "ViewHandler arguments error: "
                          "HttpRequest can only be the last argument");
            static_assert(Last || !std::is_same<Arg, HttpResponder &&>::value,
                          "ViewHandler arguments error: "
                          "HttpResponder can only be the last argument");

            static_assert(!std::is_same<Arg, HttpRequest &&>::value,
                          "ViewHandler arguments error: "
                          "HttpRequest can only be passed as a const reference");
            static_assert(!std::is_same<Arg, HttpRequest &>::value,
                          "ViewHandler arguments error: "
                          "HttpRequest can only be passed as a const reference");
            static_assert(!std::is_same<Arg, const HttpRequest *>::value,
                          "ViewHandler arguments error: "
                          "HttpRequest can only be passed as a const reference");
            static_assert(!std::is_same<Arg, HttpRequest const*>::value,
                          "ViewHandler arguments error: "
                          "HttpRequest can only be passed as a const reference");
            static_assert(!std::is_same<Arg, HttpRequest *>::value,
                          "ViewHandler arguments error: "
            ...
            static_assert(!std::is_same<Arg, HttpResponder &>::value,
                          "ViewHandler arguments error: "
                          "HttpResponder can only be passed as a universal reference");
            static_assert(!std::is_same<Arg, const HttpResponder *const>::value,
                          "ViewHandler arguments error: "
                          "HttpResponder can only be passed as a universal reference");
            static_assert(!std::is_same<Arg, const HttpResponder *>::value,
                          "ViewHandler arguments error: "
                          "HttpResponder can only be passed as a universal reference");
            static_assert(!std::is_same<Arg, HttpResponder const*>::value,
                          "ViewHandler arguments error: "
                          "HttpResponder can only be passed as a universal reference");
            static_assert(!std::is_same<Arg, HttpResponder *>::value,
                          "ViewHandler arguments error: "
            ...
            static_assert(QMetaTypeId2<Type>::Defined
                          || std::is_same<Type, HttpResponder>::value
                          || std::is_same<Type, HttpRequest>::value,
                          "ViewHandler arguments error: "
